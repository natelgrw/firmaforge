...
function addfavorite()
{
   if (document.all)
   {
      window.external.addFavorite('http://www.mywifiext.net','<%16%> Configuration');
   }
   else if (window.sidebar)
   {
      window.sidebar.addPanel('<%16%> Configuration', 'http://www.mywifiext.net', "");
   }
}

function msg_close()
{
    var ca_add_bookmark="<%4191%>";
