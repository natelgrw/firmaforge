...
var StartChannel = new Array(<%4304%>);
var FinishChannel = new Array(<%4305%>);
...
var curr_region = "<%24%>"
var curr_channel_5g_value = "<%1939%>"
var curr_channel_2g_value = "<%1919%>"
...
function setOpMode_24g_psr()
{
    ...
    if ((sec_type_2G == "None") || (sec_type_2G == "WPA2-PSK")|| (sec_type_2G == "WPA-AUTO-PSK"))
    {
        ...
        cf.opmode.options[0].text = "<%4310%>";
        cf.opmode.options[1].text = "<%4311%>";
